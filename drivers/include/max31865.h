 ...
 *
 * @note See the <a href="https://www.analog.com/media/en/technical-documentation/data-sheets/MAX31865.pdf">
...
typedef enum {
    ...
    MAX31865_FAULT_VOLTAGE      = 4     /**< Overvoltage or undervoltage on either of the FORCE or RTD pins */
} max31865_fault_t;
 ...
 */
typedef struct {
    int32_t rtd_temperature_cdegc;      /**< RTD temperature in Celsius centi-degrees (0.01°C) */
 ...
 * This is the case if the capacitor accross the RTD has the
 ...
 * if the capacitance accross the RTD is as recommended in the datasheet --
